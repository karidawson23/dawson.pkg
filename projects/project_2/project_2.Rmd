...
#AMW: It's like anti-predictive. Amazing. 
```
...
hist(residuals, main = "Residuals Histogram")
 ...
 #AMW: The idea of doing a Shapiro-Wilk test is interesting. I wonder if people actually do that in practice?
...
```{}
I tried to puch my document but there was an issue authenticsting my account. But what I planned to do was go back to the git section, select my project_2 document and then selct puch which would ultimatly lead me to my github directory. Anytime I try, it says the authentication has failed.I think my steps are correct but I dont know why it wont allow me to put my credentials in to push it through. I. will try and figure it out. 

#AMW: We can figure it out when we're back in class
```
